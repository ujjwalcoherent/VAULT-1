...
function UpcomingReportsContent() {
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 lg:px-8">
      ...
      {loading ? (
        ...
        <div className="py-16 text-center">
          <p className="text-muted-foreground">No upcoming reports found for this category.</p>
        </div>
      )}
...
export default function UpcomingReportsPage() {
  return (
